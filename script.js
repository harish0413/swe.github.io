...
const RESET = () => {
  ...
  // setTimeout(() => {
  //   window.location.href = "swe2.html"; // Replace "new-page.html" with the URL of your new page
  // }, 2000);
};
RESET();
...
// Define a variable to track whether the button has been clicked
...
BTN.addEventListener('click', () => {
  ...
  buttonClicked = true;
  // Restart the master timeline
  MASTER_TL.restart();
});

// Add an onComplete callback to the master timeline
MASTER_TL.eventCallback('onComplete', () => {
  // Check if the button has been clicked and all animations are over
  if (buttonClicked) {
